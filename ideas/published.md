...
公開後は、元原稿のfront matterにも公開URLを反映します。note記事は `published.note` とこの一覧のnote列へ公開URLを記録します。Zenn native articleはZenn Front Matterの仕様を優先し、公開URLはこの一覧とNotionへ記録します。
